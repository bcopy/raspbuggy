...
// General settings.
title = 'Raspbuggy' // blog name for the header, title and RSS feed
//subtitle = 'An autonomous Wifi-enabled programmable RC car' // blog brief description for the header
author = 'CERN Micro Club Robotics'                 // author name for Copyright, Metadata and RSS feed
meta_description = 'An autonomous Wifi-enabled programmable RC car, sponsored by the CERN Micro Club'               // blog description for Metadata
...
rss {
    ...
    email = 'cmc.robotics@cern.ch'                      // email address for the RSS feed
...
default_asides = ['asides/recent_posts.html', 'asides/github.html', 'asides/tweets.html',
        'asides/about.html', 'asides/twitter.html']
...
asides {
    ...
    // GitHub repositories.
    github {
        user = 'cmcrobotics'           // GitHub (https://github.com/) username
    ...
    // The latest tweets.
    tweets {
        user = 'CmcRobotics'           // Twitter (https://twitter.com/) username
        count = 3                   // the number of tweets to display
        consumer_key = 'UCVNloAdyjIjRXoQR5jCmyt1Y'         // to get consumer key and secret go to https://dev.twitter.com/apps and create a new application
        consumer_secret = '2Q1mpJDXI2gylVkWDCVkvJlicOKvxdLm3nD8q35qf5b76QlcxF'
        access_token = '3131277773-2vGO3KaGDmhkPrNrpZ9iWSgB8pAhlh4W3ImNwzU'
        secret_token = 'do9oidaAFWMIgtHswGGthmCEQbsDZfiyoibQO6WeZncKQ'
        follow_button {
            size = 'large'          // 'large' or 'medium'
            lang = 'en'             // one of 'en', 'fr', 'de', 'it', 'es', etc.
            show_name = true        // defines whether or not to show username
            show_count = false       // defines whether or not to show the number of followers
        }
    }
    ...
    about_author = 'The CERN Micro Club robotics section, proud sponsor of the Raspbuggy project.'
}
